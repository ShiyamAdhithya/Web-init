        ...
        if(opts.style){
            ...
            if(opts.style === 'CSS'){
                rules.push({
                    ...
                    devPackagesToInstall = devPackagesToInstall.concat(['style-loader','css-loader']);
            }
                ...
                devPackagesToInstall = devPackagesToInstall.concat(['style-loader', 'css-loader','sass-loader']);
            }
